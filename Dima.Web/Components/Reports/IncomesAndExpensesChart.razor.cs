...
public partial class IncomesAndExpensesChartComponent : ComponentBase
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            Snackbar.Add("Não foi possível carregar o gráfico de receitas e despesas.", Severity.Error);
            return;
        }
        ...
        foreach (var item in result.Data)
        {
            ...
            expenses.Add(-(double)item.Expenses);//gráfico só espera valor positivo, por isso precisa inverter o valor
    ...
    private static string GetMonthName(int month) => new DateTime(DateTime.Now.Year, month, 1).ToString("MMMM", CultureInfo.CurrentCulture);
    #endregion
