...
public interface IReportHandler
{
    ...
    Task<Response<List<IncomesByCategory>?>> GetIncomesByCategoryReport(GetIncomesByCategoryRequest request);
    Task<Response<List<ExpensesByCategory>?>> GetExpensesByCategoryReport(GetExpensesByCategoryRequest request);
